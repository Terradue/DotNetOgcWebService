...
namespace Terradue.WebService.Ogc.Wps {
    ...
    /// </summary>
    public class GetCapabilitiesOperation : BaseWpsOperation
    {
            ...
            get
            {
                ...
                parameters.Add(new DomainType()
                {
                    ...
                    AllowedValues = new Collection<object>()
                    {
                        ...
                        new Terradue.ServiceModel.Ogc.Ows11.ValueType("ProcessOfferings"),
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual OperationsMetadata GetOperationsMetadata(IHttpContextAccessor accessor, IMemoryCache cache, IServiceProvider serviceProvider)
        {
            ...
            foreach (ServiceOperationElement operationInfo in this.Services.ToList())
            {
                ...
                BaseOperation operationHandler = operationInfo.CreateHandlerInstance(accessor,cache,serviceProvider);
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual ProcessOfferings GetProcessOfferings()
        {
            ProcessOfferings c = new ProcessOfferings();

            var processes = this.GetProcesses();

			c.Process = processes.Values.Select<WpsProcess, ProcessBriefType>(o => o.ProcessBrief).ToList();
