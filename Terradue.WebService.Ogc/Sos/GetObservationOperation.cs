...
namespace Terradue.WebService.Ogc.Sos {
    ...
    public class GetObservationOperation : BaseSosOperation
    {
        ...
        public GetObservationOperation(ServiceOperationElement configuration, SosEntitiesFactory entitiesFactory, IHttpContextAccessor accessor, IMemoryCache cache, IServiceProvider serviceProvider)
